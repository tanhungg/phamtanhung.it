...
const translations = {
  vi: {
    ...
    "hero.description": "Cử nhân Công nghệ Thông tin, chuyên ngành Công nghệ Phần mềm, có kinh nghiệm hỗ trợ kỹ thuật tại FPT Telecom và IDG Việt Nam. Có kinh nghiệm hỗ trợ người dùng, xử lý sự cố liên quan đến Internet, camera, thiết bị CNTT, WordPress và các hệ thống vận hành nội bộ. Có nền tảng cơ bản về Windows, Microsoft 365, LAN/Wi-Fi và mong muốn phát triển lâu dài trong lĩnh vực IT Support và Help Desk.",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    "hero.role": "IT Support · Technical Support · Software Engineering",
    "hero.description": "Bachelor of Information Technology, majoring in Software Engineering, with technical support experience at FPT Telecom and IDG Vietnam. Experienced in supporting end users and troubleshooting issues related to Internet services, cameras, IT equipment, WordPress, and internal operational systems. Possesses fundamental knowledge of Windows, Microsoft 365, and LAN/Wi-Fi networks, and is seeking long-term career development in IT Support and Help Desk.",
